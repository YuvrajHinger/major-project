                ...
                <div class="mother-grid-inner">
                            ...
                            echo '
                                <div class="alert alert-danger alert-dismissible">                  			
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  			        <i class="icon fa fa-ban"></i> Enter Correct Authentication Key.
              			        </div> 
                            ';
                    ...
                    <div class="myform bg-light">
                        ...
                        <?php }
                            ...
                            <a class="btn btn-danger" disabled>Expired</a>
                        <?php }
                        else if($wait==2){ ?>
                            <a class="btn btn-success" disabled>completed</a>
                        <?php }
                        else{ ?>
                            <a class="btn btn-primary" disabled><?php echo $diff->format('%a days');?> Remaining</a>
                        <?php }?>
                        </div>
                    </div>
                    <?php }?>
