						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span> Candidate</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										  <ul id="menu-academico-sub" >										   
												<li id="menu-academico-avaliacoes" ><a href="addstudent.php">Add Candidate</a></li>
												<li id="menu-academico-avaliacoes" ><a href="studentlist.php"> List Of Candidate</a></li>
										  </ul>
										</li>
